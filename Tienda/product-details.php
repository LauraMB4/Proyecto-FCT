...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	if(isset($_SESSION['cart'][$id])){
		...
		if(mysqli_num_rows($query_p)!=0){
			...
			header('location:my-cart.php?pid='.$id.'&cid='.$cid.'&scid='.$scid);
		}else{
...
?>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
							<a href="product-details.php?scid=<?php echo htmlentities($rws['category']);?>&cid=<?php echo htmlentities($rws['category']);?>&pid=<?php echo htmlentities($rws['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rws['id']);?>/<?php echo htmlentities($rws['productImage1']);?>" width="150" height="240" alt=""></a>
							</div>
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								...
								<?php
									if($rws['productPriceBeforeDiscount'] <> 0){
								?>
						...
						<a href="product-details.php?action=add&id=<?php echo $rws['id']; ?>&pid=<?php echo $rws['id']; ?>&cid=<?php echo $rws['category']; ?>&scid=<?php echo $rws['subCategory']; ?>" class="lnk btn btn-primary" style="height:34px;padding-top: 5px;">Agregar a carrito</a>
...
?>
    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div id="owl-single-product">
			...
			<?php
				if(is_null($row['productImage2']) == 0){
			?>
			...
			<?php 
				...
				if(is_null($row['productImage3']) == 0){
			?>
...
<?php } ?>
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											...
											<?php
												if($row['productPriceBeforeDiscount'] <> 0)
												{
											?>	
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
										<a href="product-details.php?action=add&id=<?php echo $row['id']; ?>&pid=<?php echo $row['id']; ?>&cid=<?php echo $row['category']; ?>&scid=<?php echo $row['subCategory']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> Agregar a compras</a>
									</div>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?scid=<?php echo htmlentities($rw['category']);?>&cid=<?php echo htmlentities($rw['category']);?>&pid=<?php echo htmlentities($rw['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rw['id']);?>/<?php echo htmlentities($rw['productImage1']);?>" width="150" height="240" alt=""></a>
			</div><!-- /.image -->			
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				...
				<?php
					if($rw['productPriceBeforeDiscount'] <> 0){
				?>
