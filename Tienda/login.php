...
if($query)
{
	echo "<script>alert('Usted se ha registrado con éxito');</script>";
}
else{
echo "<script>alert('No registrado, algo ha salido mal');</script>";
}
}
// Code for User login
...
<html lang="es">
	<head>
	    ...
	    <title>Tienda Physique 24 Gym | Signi-in | Signup</title>
