...
<!-- ================================== TOP NAVIGATION : END ================================== -->	            <div class="sidebar-module-container">
	            	<h3 class="section-title">buscar por</h3>
...
{?>							
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?scid=<?php echo htmlentities($row['subCategory']);?>&cid=<?php echo htmlentities($row['category']);?>&pid=<?php echo htmlentities($row['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="" width="200" height="300"></a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
							...
							<a href="category.php?page=product&action=add&id=<?php echo $row['id']; ?>&cid=<?php echo $row['category']; ?>">
