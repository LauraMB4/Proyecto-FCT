...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	if(isset($_SESSION['cart'][$id])){
		...
		header('Location:sub-category.php?cid='.$cid.'&scid='.$scid);
	}else{
...
{?>							
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>&scid=<?php echo $scid;?>&cid=<?php echo $cid;?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="" width="200" height="300"></a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
							...
							<a href="sub-category.php?action=add&id=<?php echo $row['id']; ?>&cid=<?php echo $row['category']; ?>&scid=<?php echo $row['subCategory']; ?>">
