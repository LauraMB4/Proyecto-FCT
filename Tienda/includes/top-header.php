...
<?php if(strlen($_SESSION['login']))
    {   ?>
				<li><i class="icon fa fa-user"></i> Bienvenido - <?php echo htmlentities($_SESSION['username']);?></li>
<?php
	}
	if($_SESSION['type'] == 1){
?>
		<li><a href="admin\index.php"><i class="icon fa fa-user"></i>Administrar</a></li>
<?php
	}
